...
func (u *User) Login(w http.ResponseWriter, r *http.Request) {
	var logRequest models.LoginRequest
	...
	if !ok {
		...
		fmt.Println("UserI  not exist", ok)
		err = json.NewEncoder(w).Encode(&message)
		if err != nil {
			fmt.Println(err)
			return
...
func (u *User) LoginValidation(logReq models.LoginRequest) (user *models.User, ok bool) {
...
func (u *User) CheckUserExist(email string) (*models.User, bool) {
